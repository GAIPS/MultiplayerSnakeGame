...
from msg.utils import compare_results
from msg import MultiplayerSnakeEnvironment
...
def run_multi_agent(environment: MultiplayerSnakeEnvironment, agents: Sequence[Agent], n_episodes: int, render: bool, episode_index: int, episode_every: int) -> np.ndarray:
    episodes = {}
...
if __name__ == '__main__':
    ...
    environment = MultiplayerSnakeEnvironment(grid_shape=s["grid"], n_agents=len(s["agents"]), max_steps=None)
    environment.seed()
